## Kotlin Sample App
[![CircleCI](https://circleci.com/gh/VMadalin/TheAdventPress/tree/master.svg?style=shield)](https://circleci.com/gh/VMadalin/TheAdventPress/tree/master)
[![Codecov](https://codecov.io/gh/VMadalin/TheAdventPress/coverage.svg)](https://codecov.io/gh/VMadalin/TheAdventPress)
[![Codacy](https://api.codacy.com/project/badge/Grade/5970b6648df0465588f9781ae6e3332e)](https://www.codacy.com/manual/jeffnyauke/TheAdventPress?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=jeffnyauke/TheAdventPress&amp;utm_campaign=Badge_Grade)
...
The Advent Press is a sample project that presents modern, 2019 approach to [Android](https://www.android.com/) application development using [Kotlin](https://kotlinlang.org/) and latest tech-stack.
...
-   [Development](https://github.com/jeffnyauke/TheAdventPress#development)
-   [Design](https://github.com/jeffnyauke/TheAdventPress#design)
-   [Architecture](https://github.com/jeffnyauke/TheAdventPress#architecture)
-   [Documentation](https://github.com/jeffnyauke/TheAdventPress#documentation)
...
|---------------------------------------------------------|----------------------------------------------------------------------------------:|---------------------------|---------------------------|
| [detekt](https://github.com/arturbosch/detekt)          | [/.detekt](https://github.com/jeffnyauke/TheAdventPress/tree/master/.detekt)     | `./gradlew detekt`        | -                         |
| [ktlint](https://github.com/pinterest/ktlint)           | -                                                                                 | `./gradlew ktlint`        | `./gradlew ktlintFormat`  |
| [spotless](https://github.com/diffplug/spotless)        | [/.spotless](https://github.com/jeffnyauke/TheAdventPress/tree/master/.spotless) | `./gradlew spotlessCheck` | `./gradlew spotlessApply` |
| [lint](https://developer.android.com/studio/write/lint) | [/.lint](https://github.com/jeffnyauke/TheAdventPress/tree/master/.lint)         | `./gradlew lint`          | -                         |
...
To consult it check this [link](https://jeffnyauke.github.io/TheAdventPress/) or open the project `/docs` directory.
...
-   [and more...](https://github.com/jeffnyauke/TheAdventPress/blob/master/buildSrc/build-dependencies.gradle.kts)
...
```license
Copyright 2019 jeffnyauke@gmail.com
